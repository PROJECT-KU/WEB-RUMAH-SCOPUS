...
<!--<section class="clearfix about about-style2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <img  src="<?php echo base_url() . 'theme/images/logo/scopus1.png' ?>" class="img-fluid about-img" alt="#">
            </div>
        </div>
    </div>
</section>-->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="single-item">
                    ...
                    <div class="quote">
                        <i class="fa fa-quote-left" aria-hidden="true"></i>
                        <p class="quote_text">saya sangat bangga bisa belajar banyak di Rumah Scopus </p>
                        <div class="testi-img_block">
                            <!--<img src="<?php echo base_url() . 'theme/images/student-2.png' ?>" class="img-fluid" alt="#">-->
                            <p><span></span></p>
                        </div>
