...
<section class="events">
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <h2 class="event-title">Branch</h2>
      </div>
      <div class="col-md-8">
        <!-- Nav tabs -->
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item nav-tab1">
            <a class="nav-link tab-list active" data-toggle="tab" href="#upcoming-events" role="tab">Branch Rumah Scopus </a>
          </li>
    ...
    <div class="card">
      <div class="card-header" id="headingsFive">
        <h1 class="mb-0">
          <button class="btn btn-outline-info" type="button" data-toggle="collapse" data-target="#collapsesFive" aria-expanded="false" aria-controls="collapsesFive">
           Branch 4
          </button>
        </h1>
      </div>
      <div id="collapsesFive" class="collapse" aria-labelledby="headingsFive" data-parent="#accordionExample">
    ...
    <div class="card">
      <div class="card-header" id="headingEleven">
        <h1 class="mb-0">
          <button class="btn btn-outline-info" type="button" data-toggle="collapse" data-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
            Branch 9
          </button>
        </h1>
      </div>
