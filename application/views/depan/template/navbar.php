             ...
             <div class="col-xs-6 col-sm-8 col-md-9">
                 <div class="header-top_address">
                     <div class="header-top_list">
                         <span class="icon-phone"></span>(+62) 812-2688-3280
                     </div>
                     <div class="header-top_list">
                         <span class="icon-envelope-open"></span>info@rumahscopus.com
                     </div>
                     <div class="header-top_list">
                         <span class="icon-location-pin"></span>Bangunsari, Bangunkerto, Turi, Sleman, Yogyakarta 55551
                     </div>
                 </div>
         ...
         <div class="row">
             <div class="col-md-12">
                 <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                     ...
                     <a href="<?php echo site_url(''); ?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="150px;" src="<?php echo base_url() . 'theme/images/logo/logo.png' ?>"></a>
