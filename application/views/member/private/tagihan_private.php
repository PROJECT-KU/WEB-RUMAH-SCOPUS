                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="callout callout-info" style="background-color: 00C0EF; color:white;">
                                ...
                                Silahkan copy terlebih dahulu KODE BOOKING, sebelum melakukan pembayaran.
                                <h1><?= $this->session->flashdata('private'); ?></h1>
                            </div>
                                                ...
                                                <?php if ($t['status'] == 0) : ?>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><?= $hasil_rupiah ?></td>
                                                            <td>Pending</td>
                                                            <td><a href="<?= base_url('member/tagihan/cancel_private/') . $t['id'] ?>" class="btn btn-danger">Cancel</a></td>
                                            ...
                                            <div class="modal-body">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="<?= base_url('member/tagihan/submit_private') ?>" class="btn btn-primary">Bayar Sekarang!</a>
