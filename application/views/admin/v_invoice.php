...
<body class="hold-transition skin-blue sidebar-mini">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:right;">
                                                        ...
                                                        <a class="btn" data-toggle="modal" href="<?php echo base_url('admin/invoice/delete/') .  $i['id']; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--Modal Edit Pengguna-->
    <div class="modal fade" id="ModalEdit<?php echo $i['id_order']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url() . 'admin/invoice/edit' ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Email</label>
                            <div class="col-sm-7">
                                <input type="hidden" name="kode" value="<?php echo $i['id_order']; ?>">
