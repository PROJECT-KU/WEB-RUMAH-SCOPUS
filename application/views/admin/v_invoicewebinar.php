        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?= base_url('admin/webinar') ?>"><i class="fa fa-list"></i> Webinar</a></li>
                    <li class="active">Invoice Webinar</li>
                </ol>
            </section>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $i['tanggal_pelaksanaan']; ?></td>
                                                    ...
                                                    <td style="text-align:right;">
                                                        <a class="btn" data-toggle="modal" href="<?php echo base_url('admin/invoicewebinar/konfir/') .  $i['id']; ?>"><span class="fa fa-check-circle"></span></a>
                                                         <a class="btn" data-toggle="modal" href="<?php echo base_url('admin/invoicewebinar/pending/') .  $i['id']; ?>"><span class="fa fa-close"></span></a>
                                                         <a class="btn" data-toggle="modal" href="<?php echo base_url('admin/invoicewebinar/delete/') .  $i['id']; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Edit Invoice Webinar</h4>
                </div>
                <form class="form-horizontal" action="<?php echo base_url() . 'admin/invoicewebinar/edit' ?>" method="post" enctype="multipart/form-data">
